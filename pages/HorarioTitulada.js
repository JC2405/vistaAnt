    ...
    setupEventListeners() {
        ...
        const _cerrarDropdownDisponibles = () => {
            if (this._ddAmbienteDisponibles) {
                // Remover el panel del DOM directamente
        ...
        const _abrirDropdownDisponibles = () => {
            ...
            // Crear dropdown flotante posicionado sobre el botón
            const btn = btnAmbientesLibres;
            const rect = btn.getBoundingClientRect();

            // Construir el panel manualmente (igual que sd-dropdown pero sin triggerEl)
            const panel = document.createElement('div');
            panel.className = 'sd-dropdown';
            // El endpoint retorna: { idAmbiente, nombreCompleto }
            // donde nombreCompleto = "nombreArea - bloque" (construido en el servidor)
            ...
            // Insertar dentro del modal para evitar trampa de focus de Bootstrap
            ...
            // Guardar referencia para poder destruirlo luego
