...
class AreasPage {
    ...
    renderTable(data = null) {
        ...
        // Inicializar DataTables con botones (ocultos, los usamos via toolbar)
        if (typeof $ !== 'undefined' && $.fn.dataTable) {
            this.dtInstance = $('#areas-table').DataTable({
                responsive: true,
                paging: false,
                info: false,
                searching: false,
            ...
            // Conectar los botones del toolbar con las acciones de DataTables
            this.bindToolbarButtons();
        }

        // Event Listeners de acciones de filas
    ...
    bindToolbarButtons() {
        ...
        // Mapa: texto del botón toolbar -> índice en el array de buttons de DT
        const buttonMap = {
            'btn-colvis': 0,
            'btn-excel':  1,
            'btn-pdf':    2,
        ...
        Object.entries(buttonMap).forEach(([btnId, dtIndex]) => {
